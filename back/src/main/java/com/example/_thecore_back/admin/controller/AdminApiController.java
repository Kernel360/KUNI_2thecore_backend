...
import com.example._thecore_back.admin.controller.dto.AdminRegisterRequest;
import com.example._thecore_back.admin.controller.dto.AdminResponse;
import com.example._thecore_back.admin.controller.dto.AdminUpdateRequest;
...
public class AdminApiController {
    ...
    //회원가입 api
    @PostMapping("/signup")
    public ResponseEntity<ApiResponse<AdminResponse>> registerAdmin(@RequestBody AdminRegisterRequest requestDto) {
    ...
    //회원 정보 수정 api
    @PutMapping("/{loginId}")
    public ResponseEntity<ApiResponse<AdminResponse>> updateAdmin(@PathVariable String loginId, @RequestBody AdminUpdateRequest requestDto) {
